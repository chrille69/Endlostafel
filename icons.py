...
iconssvg = {
    ...
    'radierer-kalibrieren': '''
        <svg width="16" height="16" version="1.1" xmlns="http://www.w3.org/2000/svg">
            <path d="m5.0409 11.357 6.4693-6.4693s.51754-.51754 0-1.0351l-3.6228-3.6228c-.51754-.51754-1.0351 0-1.0351 0l-6.4693 6.4693c-.51754.51754-.51754 1.0351 0 1.5526l3.1052 3.1052zm-.51754-1.5526h-.51754l-1.8114-1.8114c-.51754-.51754-.51754-.51754 0-1.0351l3.1052-3.1052 2.5877 2.5877z" style="fill:{htmlcolor}; stroke: none"/>
            <g transform="matrix(1.3005 0 0 1.3005 -4.1375 -4.3885)" style="fill:none; opacity:.992; stroke-width:.9; stroke:{htmlcolor}">
                ...
                <g>
                    <path d="m9.5049 11.935h-1.5049" />
                    <path d="m15.484 11.935h-1.5049" />
                    <path d="m11.742 9.6979v-1.5049" />
                    <path d="m11.742 15.677v-1.5049" />
                </g>
                <path d="m12.932 11.935a1.19 1.19 0 01-1.19 1.19 1.19 1.19 0 01-1.19-1.19 1.19 1.19 0 011.19-1.19 1.19 1.19 0 011.19 1.19z" style="fill:{htmlcolor}; stroke: none"/>
            </g>
        </svg>''',
    'undo': '''
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" version="1.1">
